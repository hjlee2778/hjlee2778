...
- ## **[한끼모아(외식비 절약 목표 달성을 위한 지출 관리 서비스)](https://github.com/CSID-DGU/2025-1-SCS4031-JJangIJI-04)**
    - 역할(Front-end):
       - 실시간 반영 달력 구현
       - 이모지 시스템 구현
       - 리액트 쿼리를 통해 실시간 반응 구축 (타인의 목표 확인 등)
    - 개발 담당 : 프론트엔드 2명, 백엔드 2명
    - 기간 : 2025. 03. 20 ~ 2025. 06. 05
